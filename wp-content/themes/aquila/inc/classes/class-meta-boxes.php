...
class Meta_Boxes{
    ...
    public function custom_meta_box_html( $post ) {
         ...
         * */
        wp_nonce_field(plugin_basename(__FILE__), 'hide_meta_box_title_nonce_name');
    ...
    public function save_post_meta_data($post_id){
         ...
         * */
        if(!isset($_POST['hide_meta_box_title_nonce_name']) || ! wp_verify_nonce($_POST['hide_meta_box_title_nonce_name'], plugin_basename(__FILE__))){
            return;
        }
